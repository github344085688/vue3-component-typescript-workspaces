<template>
            <div  class="sig-in-box">
                ...
                <div class="win100 mt-4 d-flex justify-content-center align-items-center ">
                    <button type="button" class="unis-btn unis-btn-link " @click.stop.prevent="checkPageName('forgotPassword')">
                        Forgot password?
                    </button>
                </div>
                ...
                <div class="d-flex flex-wrap win100 align-items-center mb-5">
                    <div class="pr-sa-3 pl-0 col  d-flex justify-content-center f-b mt-4">
                        <button type="button" class="unis-btn full   unis-btn-tertiary" @click="getRegisterLoging('google')">
                    ...
                    <div class="pl-sa-3 pr-0 col  d-flex justify-content-center f-b mt-4">
                        <button type="button" class="unis-btn full   unis-btn-tertiary " style="background: #4267B2"
